...
public class Win32PnPEntityService implements CommonServiceInterface<Win32PnPEntity> {
    ...
    public @NonNull List<Win32PnPEntity> get(long timeout) {
        TerminalResult terminalResult = terminalService.executeQuery(Cimv2.WIN32_PNP_ENTITY, timeout);
        return mapper.mapToList(terminalResult.result(), Win32PnPEntity.class);
    }
}
