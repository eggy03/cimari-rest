...
public class Win32ProcessService implements CommonServiceInterface<Win32Process> {
    ...
    public @NonNull List<Win32Process> get(long timeout) {
        TerminalResult terminalResult = terminalService.executeQuery(Cimv2.WIN32_PROCESS, timeout);
        return mapper.mapToList(terminalResult.result(), Win32Process.class);
    }
}
