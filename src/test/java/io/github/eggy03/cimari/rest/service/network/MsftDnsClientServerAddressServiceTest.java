...
class MsftDnsClientServerAddressServiceTest {
    ...
    private final MsftDnsClientServerAddress expectedDns1 = new MsftDnsClientServerAddress(
            1L,
            "Ethernet",
            2,
    ...
    private final MsftDnsClientServerAddress expectedDns2 = new MsftDnsClientServerAddress(
            2L,
            "Wi-Fi",
            23,
            Arrays.asList("2001:4860:4860::8888", "2001:4860:4860::8844")
    );
    ...
    void test_get_serviceReturnsMapperResult() {
        ...
        verify(mapper).mapToList(validTerminalResult.result(), MsftDnsClientServerAddress.class);
    ...
    void test_get_mapperThrows_servicePropagatesException() {
        ...
        verify(terminalService).executeQuery(StandardCimv2.MSFT_NET_DNS_CLIENT_SERVER_ADDRESS, 5L);
        verify(mapper).mapToList(invalidTerminalResult.result(), MsftDnsClientServerAddress.class);
        verifyNoMoreInteractions(terminalService);
        verifyNoMoreInteractions(mapper);
    }
    ...
    void test_get_serviceReturnsEmpty_whenMapperReturnsEmpty() {
        ...
        verify(terminalService).executeQuery(StandardCimv2.MSFT_NET_DNS_CLIENT_SERVER_ADDRESS, 5L);
        verify(mapper).mapToList(emptyTerminalResult.result(), MsftDnsClientServerAddress.class);
        verifyNoMoreInteractions(terminalService);
        verifyNoMoreInteractions(mapper);
    }
}
