...
class Win32SoundDeviceServiceTest {
    ...
    private final Win32SoundDevice expectedDevice1 = new Win32SoundDevice(
            "AUDIO\\0001",
    ...
    private final Win32SoundDevice expectedDevice2 = new Win32SoundDevice(
            "AUDIO\\0002",
            "NVIDIA High Definition Audio",
            "HDAUDIO\\FUNC_01&VEN_10DE&DEV_0080&SUBSYS_10DE1467&REV_1001",
            "NVIDIA Corporation",
            "OK",
            3
    );
    ...
    void test_get_serviceReturnsMapperResult() {
        ...
        verify(mapper).mapToList(validTerminalResult.result(), Win32SoundDevice.class);
    ...
    void test_get_mapperThrows_servicePropagatesException() {
        ...
        verify(terminalService).executeQuery(Cimv2.WIN32_SOUND_DEVICE, 5L);
        verify(mapper).mapToList(invalidTerminalResult.result(), Win32SoundDevice.class);
        verifyNoMoreInteractions(terminalService);
        verifyNoMoreInteractions(mapper);
    }
    ...
    void test_get_serviceReturnsEmpty_whenMapperReturnsEmpty() {
        ...
        verify(terminalService).executeQuery(Cimv2.WIN32_SOUND_DEVICE, 5L);
        verify(mapper).mapToList(emptyTerminalResult.result(), Win32SoundDevice.class);
        verifyNoMoreInteractions(terminalService);
        verifyNoMoreInteractions(mapper);
    }
