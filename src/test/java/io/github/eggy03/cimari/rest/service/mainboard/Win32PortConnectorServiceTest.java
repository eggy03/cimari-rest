...
class Win32PortConnectorServiceTest {
    ...
    private final Win32PortConnector expectedPort1 = new Win32PortConnector(
            "PortConnector1",
            "USB3_0",
            "JUSB1",
            1,
    ...
    private final Win32PortConnector expectedPort2 = new Win32PortConnector(
            "PortConnector2",
            "HDMI_OUT",
            "JHDMI1",
            2,
    ...
    void test_get_serviceReturnsMapperResult() {
        ...
        verify(mapper).mapToList(validTerminalResult.result(), Win32PortConnector.class);
    ...
    void test_get_mapperThrows_servicePropagatesException() {
        ...
        verify(terminalService).executeQuery(Cimv2.WIN32_PORT_CONNECTOR, 5L);
        verify(mapper).mapToList(invalidTerminalResult.result(), Win32PortConnector.class);
        verifyNoMoreInteractions(terminalService);
        verifyNoMoreInteractions(mapper);
    }
    ...
    void test_get_serviceReturnsEmpty_whenMapperReturnsEmpty() {
        ...
        verify(terminalService).executeQuery(Cimv2.WIN32_PORT_CONNECTOR, 5L);
        verify(mapper).mapToList(emptyTerminalResult.result(), Win32PortConnector.class);
        verifyNoMoreInteractions(terminalService);
        verifyNoMoreInteractions(mapper);
    }
